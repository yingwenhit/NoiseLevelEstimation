...
if __name__ == '__main__':
    ...
    specify_str = '-In-'
    path = '/Users/wenying/OneDrive/0.PhD.Candidate/12. NPSID_IEEE/NPSID_IEEE/Matlab_code/NoiseLevelEstimation/NLE_image'
    ...
    for file in files:
        if "-In-" in file:
            ...
            str_p = "Name: {0:s} Time: {1:.4f}, Estimated Level: {2:6.4f}"
            print(str_p.format(file, time_elapsed, est_level))
